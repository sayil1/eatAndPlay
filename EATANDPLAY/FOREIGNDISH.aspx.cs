...
{
    public partial class FOREIGNDISH : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            string insertquery = " insert into FOREIGNDISH (VENUE,TIME,DATE,PHONE,ITEM1,ITEM2,ITEM3) values(@VENUE,@TIME,@DATE,@PHONE,@ITEM1,@ITEM2,@ITEM3) ";
            ...
            comm.Parameters.AddWithValue("@ITEM2", DropDownList3.SelectedValue);
            comm.Parameters.AddWithValue("@ITEM3", DropDownList6.SelectedValue);
