...
{
    public partial class AFRICANDISH : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            string insertquery = " insert into AFRICANDISH (VENUE,TIME,DATE,PHONE,ITEM1,ITEM2,ITEM3,ITEM4) values(@VENUE,@TIME,@DATE,@PHONE,@ITEM1,@ITEM2,@ITEM3,@ITEM4) ";
            ...
            comm.Parameters.AddWithValue("@ITEM2", DropDownList2.SelectedValue);
            comm.Parameters.AddWithValue("@ITEM3", DropDownList3.SelectedValue);
            comm.Parameters.AddWithValue("@ITEM4", DropDownList6.SelectedValue);
